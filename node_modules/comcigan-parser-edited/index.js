...
class Timetable {
  ...
  /**
   * @description 입력된 키워드를 통해 학교를 조회하여 결과를 리턴합니다.
   * @param {string} keyword 학교 검색 키워드
   * @return {Object
   */
  async searchSchool(keyword) {
    ...
    if (typeof errorMessage === "string") {
      return { searchSchool: false, data: errorMessage };
    } else {
      return { searchSchool: true, data: result_ };
    }
  }
